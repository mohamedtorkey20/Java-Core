...
public class InMemoryWorldDao implements WorldDao {
	...
	//	{
		...
		//}
	//	  List<Country> countries = w.findAllCountries();
     
		
		
	    Statistics.highestPopulatedCityOfEachCountry(allCountries,allCities);
	    System.out.println("-------------------------------------------------------------------------------------------------");
			Statistics.mostPopulatedCityOfEachContinent(allCountries,allCities);
			System.out.println("-------------------------------------------------------------------------------------------------");
			Statistics.highestPopulatedCapitalCity(allCountries,allCities);
	}
